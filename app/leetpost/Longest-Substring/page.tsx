...
export default function AddTwoNumber() {
  ...
  return (
    ...
    <p className = "p-5 font-semibold">The goal is to get longest string without duplicate in the given random string. we need to map the array with the two pointer and find max length of substring</p>
